...
export default (
    ...
    <div hasSlideChildren>
        ...
        <Slide transition={['fade']} bgColor="secondary">
            <Heading size={2} textColor="blue2" bold>
                About Me
            </Heading>
            <br />
            <Appear>
                <Heading size={4} textColor="blue3">
            ...
            <Appear>
                <Heading size={4} textColor="blue3">
                    <a href="https://github.com/superoo7" target="_blank">
                        <StyledFA size="3x" icon={faGithub} />
                    </a>
                    <a href="https://codepen.io/superoo7/" target="_blank">
                        <StyledFA size="3x" icon={faCodepen} />
                    </a>
                    <a href="https://www.linkedin.com/in/superoo7/" target="_blank">
                        <StyledFA size="3x" icon={faLinkedin} />
                    </a>
                </Heading>
            </Appear>
        </Slide>
        ...
        <Slide transition={['fade']} bgColor="secondary">
            ...
            <Video src={images.qurator} autoPlay />
        </Slide>
    </div>
)
