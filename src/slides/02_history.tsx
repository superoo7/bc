...
export default (
    ...
    <div hasSlideChildren>
        ...
        <Slide transition={['zoom']} bgImage={images.btc1} bgColor="white">
            <StyledButton>
        ...
        <Slide transition={['zoom']} bgColor="skyBlue">
            {/* tslint:disable-next-line:max-line-length */}
            <StyledImg src="https://i2.wp.com/knoldus.blog/wp-content/uploads/2017/08/inked-14-638_li.jpg?resize=585%2C330&ssl=1" />
        </Slide>
    </div>
)
